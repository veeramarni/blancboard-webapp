...
REM enyo location
SET ENYO=%SRC%\..\bower_components\enyo

REM Custom addition, as the lib is pointing to /lib directory by default
REM lib location
SET LIB=%SRC%\..\bower_components"
...
%NODE% "%DEPLOY%" -T -s "%SRC%" -o "%SRC%\deploy" -e "%ENYO%" %* -l "%LIB%"
